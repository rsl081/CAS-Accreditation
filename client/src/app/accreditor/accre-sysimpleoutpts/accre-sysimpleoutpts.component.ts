...
@Component({
  selector: 'app-accre-sysimpleoutpts',
  templateUrl: './accre-sysimpleoutpts.component.html',
  styleUrls: ['./accre-sysimpleoutpts.component.css'],
})
export class AccreSysimpleoutptsComponent implements OnInit {
