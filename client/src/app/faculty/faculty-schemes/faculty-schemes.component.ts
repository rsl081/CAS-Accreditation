...
@Component({
  selector: 'app-faculty-schemes',
  templateUrl: './faculty-schemes.component.html',
  styleUrls: ['./faculty-schemes.component.css'],
})
export class FacultySchemesComponent implements OnInit {
