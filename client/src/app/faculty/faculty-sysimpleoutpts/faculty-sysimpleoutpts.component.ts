...
@Component({
  selector: 'app-faculty-sysimpleoutpts',
  templateUrl: './faculty-sysimpleoutpts.component.html',
  styleUrls: ['./faculty-sysimpleoutpts.component.css'],
})
export class FacultySysimpleoutptsComponent implements OnInit {
